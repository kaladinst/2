...
* @description Bu dosya DLinkedList sınıfının metotlarına ait gövdelere sahiptir.
...
void DLinkedList::Mutation(DLinkedList &lines) {
    cout << "Mutasyon islemi icin bir satir numarasi seciniz" << endl;
    int row;
    cin >> row;
    ...
    if (it == lines.end()) {
        cerr << "Gecersiz satir numarası" << endl;
        return;
    }

    string line = *it;
    cout << "Secilen satir: " << line << endl;
    cout << "Mutasyon islemi yapilacak genin numarasi: " << endl;
    int gene;
    cin >> gene;
    ...
    if (gene < 0 || gene >= genes.size()) {
        cerr << "Gecersiz gen numarasi" << endl;
        return;
    }
...
void DLinkedList::Crossover(DLinkedList &lines) {
    cout << "Caprazlama islemi icin ilk satir numarasi seciniz" << endl;
    int row1;
    cin >> row1;
